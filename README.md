**Important!** Some of the output of this notebook has not been included, because it makes it too big for GitHub! To see those outputs please follow this link: https://colab.research.google.com/github/CorkCork/NYPD-Motor-Vehicle-Collisions/blob/master/analyze_data/NYPD%20Motor%20Vehicle%20Collisions.ipynb or download the files to run locally in a Jupyter Notebook.
...
***** 
### The Project
In this project, our goal is to understand more about the collisions in NYC in order to help reduce collisions, injuries and fatalities. We intend to translate some of the tabular data into insights and visualizations, and share our findings with lawmakers and New Yorkers. To do so, we will analyze collision times, seasons, locations, factors and vehicle types, as well as look into the results of collisions. 
